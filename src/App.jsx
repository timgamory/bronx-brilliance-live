...
const EVENTS_DATA = [
  { id: 1, date: "Jun 20, 2024", title: "The Launch", venue: "Lehman College", hood: "Bedford Park", theme: "Building the ecosystem", highlights: ["Panel moderated by Majora Carter", "Cohort 1 Fellows introduced", "Lehman College partnership announced"], spotlights: ["Stephany Garcia, JobsFirstNYC", "Lawrence Fauntleroy, Lehman College", "John Campos, Career Connected Learning"], color: C.teal },
  { id: 2, date: "Dec 5, 2024", title: "The Next Generation", venue: "Comp Sci High", hood: "Mott Haven", theme: "Innovation meets community", highlights: ["Cohort 2 Fellows revealed", "Toured new Comp Sci High building", "M&T Bank sponsorship announced"], spotlights: ["Comp Sci High Leadership", "M&T Bank Community Team"], color: C.gold },
  { id: 3, date: "Apr 11, 2025", title: "Funding the Future", venue: "Inspiration Point", hood: "Hunts Point", theme: "Access to capital", highlights: ["Opening by Majora Carter", "Funding strategies panel", "Fellows' business showcases", "Cohort 3 application announced"], spotlights: ["Financial providers panel", "Inspiration Point & The Peninsula team"], color: C.accent },
  { id: 4, date: "Jul 9, 2025", title: "Health is Wealth", venue: "Andrew Freedman Home", hood: "Grand Concourse", theme: "Wellness meets entrepreneurship", highlights: ["Entrepreneur health journeys panel", "Table tennis exhibition by Yasiris Ortiz", "Wellness strategies workshop"], spotlights: ["Yasiris Ortiz, CEA Fellow & Pro Athlete", "Andrew Freedman Home Staff"], color: C.teal },
  { id: 5, date: "Sep 22, 2025", title: "Cohort 2 Celebration", venue: "Univ. of Mount Saint Vincent", hood: "Riverdale", theme: "Culmination and recognition", highlights: ["Fellow spotlight presentations", "Selection committee honored", "Cohort 3 finalists revealed", "UMSV partnership deepened"], spotlights: ["UMSV Faculty & Leadership", "CEA Selection Committee", "Intern team"], color: C.gold },
  { id: 6, date: "Dec 12, 2025", title: "Introducing Cohort 3", venue: "DREAM Charter High School", hood: "South Bronx", theme: "Creativity, impact, commitment", highlights: ["Emceed by Olga Perez & Chidi Asoluka", "Panel moderated by Rasheeda Frazier", "Food by Nourish & YummyTummy4Life"], spotlights: ["Olga Perez, MVP Lifeguards", "Chidi Asoluka, NewComm", "Tomas Ramos, Oyate Group & Nourish", "Rasheeda Frazier, Leadership Coach", "DREAM, BXEDC, NYPACE leaders"], color: C.accent },
];

const VENUES = [
  { name: "Lehman College", hood: "Bedford Park", year: 1968, fact: "Part of CUNY. Home to the Lehman Center for the Performing Arts, one of the Bronx's premier cultural venues.", coords: [40.8734, -73.8940], events: [1] },
  { name: "Comp Sci High", hood: "Mott Haven", year: 2018, fact: "A public high school focused on computer science, with a brand-new facility designed for the innovators of tomorrow.", coords: [40.8095, -73.9180], events: [2] },
  { name: "Inspiration Point", hood: "Hunts Point", year: 2023, fact: "A cultural arts center inside The Peninsula, a mixed-use campus at the forefront of South Bronx revitalization.", coords: [40.8176, -73.8870], events: [3] },
  { name: "Andrew Freedman Home", hood: "Grand Concourse", year: 1924, fact: "Built in 1924, now an artist hub and community center. One of the most beautiful buildings on the Grand Concourse.", coords: [40.8310, -73.9235], events: [4] },
  { name: "Mt. Saint Vincent", hood: "Riverdale", year: 1847, fact: "Founded by the Sisters of Charity of New York. A university committed to ecumenism and the development of the whole person.", coords: [40.8984, -73.9033], events: [5] },
  { name: "DREAM Charter HS", hood: "South Bronx", year: 2020, fact: "Designed by Sir David Adjaye inside a transformed 1900s ice factory. One of NYC's most inspiring school buildings.", coords: [40.8128, -73.9210], events: [6] },
];
                  ...
                  {isOpen && (
                    <div style={{
                      ...
                      <div style={{ paddingTop: 20 }}>
                        ...
                        {/* Photo Gallery Placeholder + AI Recap */}
                        <div style={{
                          ...
                          <div style={{
                            ...
                            <span style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 10, color: "#8a9498" }}>Powered by Google Photos</span>
                          </div>
                          <div style={{
                            height: 120, borderRadius: 10,
              ...
              <div style={{ padding: 28, flex: 1, animation: "fadeIn 0.3s ease-out" }}>
                ...
                <div style={{
                  ...
                  <span style={{
                    ...
                    fontWeight: 600,
                  }}>Venue Photos from Google Photos</span>
                </div>
              </div>
            ) : (
              <div style={{
